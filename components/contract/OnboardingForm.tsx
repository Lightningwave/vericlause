...
export function OnboardingForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      <h3 className="font-serif text-lg font-bold text-navy-950">{t("dash_ctx_form_title")}</h3>
      <p className="mt-1 text-sm text-slate-500 mb-6">{t("dash_ctx_form_desc")}</p>

      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-navy-900 mb-1">{t("dash_ctx_salary_label")}</label>
        ...
        <div>
          <label className="block text-sm font-medium text-navy-900 mb-1">{t("dash_ctx_work_type")}</label>
          <select
            value={workType}
          ...
          >
            <option value="office">{t("dash_ctx_work_office")}</option>
            <option value="manual">{t("dash_ctx_work_manual")}</option>
          </select>
        </div>
      </div>
